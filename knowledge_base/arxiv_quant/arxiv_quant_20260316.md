...
**发布时间**: 2026-03-12T00:42:08Z

**论文类别**: q-fin.ST

**论文链接**: https://arxiv.org/abs/2603.11408v1

**PDF链接**: https://arxiv.org/pdf/2603.11408v1.pdf

**分析时间**: 2026-03-16 08:30:03
...
This paper examines whether multi-dimensional sentiment signals extracted by large language models improve the prediction of weekly WTI crude oil futures returns.

### 研究方法/方法学

This paper examines whether multi-dimensional sentiment signals extracted by large language models improve the prediction of weekly WTI crude oil futures returns

2-3b, and two benchmark models, FinBERT and AlphaVantage
...
Overall, the results suggest that multi-dimensional LLM-based sentiment measures can improve commodity return forecasting and support energy-market risk monitoring
