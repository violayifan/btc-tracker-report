...
class MartingaleStrategy:
    ...
    def __init__(self,
        ...
        self.current_position_size = initial_position
    ...
    def generate_signal(self, price_history: List[float]) -> Dict:
        ...
        self.current_price = current_price  # 保存当前价格
        ...
        if self.position_count == 0:
            ...
            self.current_position_size = self.initial_position
