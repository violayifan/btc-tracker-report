...
def generate_enhanced_html(reports, backtest_metrics):
    ...
    annualized_return_class = "positive" if annualized_return > 0 else "negative"
    ...
    annualized_return_html = f"{annualized_return:.2f}%"
...
<body>
    <div class="container">
        ...
        <!-- 策略复盘与优化部分 -->
        <div class="section">
            <div class="section-title">🤖 策略复盘与优化</div>
            <div class="content-box">
                <p style="margin-bottom: 10px; font-weight: 500; color: #667eea;">💡 策略复盘与自动迭代</p>
                <p style="font-size: 14px; color: #666; line-height: 1.6;">
                    每次信号更新后，系统会自动复盘策略运行情况，记录可以改进的策略信号，并生成方向自动迭代策略。
                </p>
                <ul style="font-size: 13px; color: #666; line-height: 1.8; margin-left: 20px;">
                    <li>✅ 自动分析策略绩效（胜率、盈亏比、夏普比率）</li>
                    <li>✅ 识别策略优势和劣势</li>
                    <li>✅ 基于绩效自动调整策略参数</li>
                    <li>✅ 记录策略迭代历史</li>
                    <li>✅ 生成改进建议和优化方向</li>
        ...
        <div class="section">
            ...
            <div class="metric-grid">
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-value {annualized_return_class}">{annualized_return_html}</div>
                </div>
                <div class="metric-card">
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"✅ 最终版 HTML 报告已生成")
    print(f"{'='*60}")
    print(f"📱 文件: {html_file}")
    print(f"📊 所有指标显示问题已修复")
    print(f"📋 请复制文件或通过服务器访问")
    print(f"{'='*60}\n")
